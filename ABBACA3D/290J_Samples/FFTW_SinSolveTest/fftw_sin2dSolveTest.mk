#
# fftw_sin2dSolveTest program makefile using MakeScripts
#
...
CPPfiles   +=  fftw_sin2dSolveTest.cpp
INCLUDES    = -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  = fftw_sin2dSolveTest.exe
DEBUG_EXEC    = fftw_sin2dSolveTest_debug.exe

RELEASE_DIR  = ./_releasefftw_sin2dSolveTest
DEBUG_DIR    = ./_debugfftw_sin2dSolveTest
