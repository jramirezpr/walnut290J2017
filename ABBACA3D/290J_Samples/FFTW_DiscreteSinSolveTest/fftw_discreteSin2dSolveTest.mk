#
# fftw_discreteSin2dSolveTest program makefile using MakeScripts
#
...
CPPfiles   +=  fftw_discreteSin2dSolveTest.cpp
INCLUDES    = -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  = fftw_discreteSin2dSolveTest.exe
DEBUG_EXEC    = fftw_discreteSin2dSolveTest_debug.exe

RELEASE_DIR  = ./_releasefftw_discreteSin2dSolveTest
DEBUG_DIR    = ./_debugfftw_discreteSin2dSolveTest
