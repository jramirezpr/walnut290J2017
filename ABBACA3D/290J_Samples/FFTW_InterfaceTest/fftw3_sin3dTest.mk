#
# fftw3_sin3dTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = ./fftw3_sin3dTest.exe
DEBUG_EXEC    = ./fftw3_sin3dTestd.exe

RELEASE_DIR  =./_release_fftw3_sin3dTest
DEBUG_DIR    =./_debug_fftw3_sin3dTest
