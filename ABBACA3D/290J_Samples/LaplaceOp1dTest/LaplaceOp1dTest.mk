#
# LaplaceOp1dTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = LaplaceOp1dTest.exe
DEBUG_EXEC    = LaplaceOp1dTest_debug.exe

RELEASE_DIR  = ./_releaseLaplaceOp1dTest
DEBUG_DIR    = ./_debugLaplaceOp1dTest
