#
# fftw_discreteSin1dSolveTest program makefile using MakeScripts
#
...
CPPfiles   +=  fftw_discreteSin1dSolveTest.cpp
INCLUDES    = -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  = fftw_discreteSin1dSolveTest.exe
DEBUG_EXEC    = fftw_discreteSin1dSolveTest_debug.exe

RELEASE_DIR  = ./_releasefftw_discreteSin1dSolveTest
DEBUG_DIR    = ./_debugfftw_discreteSin1dSolveTest
