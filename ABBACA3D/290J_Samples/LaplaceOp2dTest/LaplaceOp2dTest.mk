#
# LaplaceOp2dTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = LaplaceOp2dTest.exe
DEBUG_EXEC    = LaplaceOp2dTest_debug.exe

RELEASE_DIR  = ./_releaseLaplaceOp2dTest
DEBUG_DIR    = ./_debugLaplaceOp2dTest
