#
# fftw__scaledCosTest program makefile using MakeScripts
#
...
CPPfiles   +=  fftw_scaledCosTest.cpp
INCLUDES    = -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  = fftw_scaledCosTest.exe
DEBUG_EXEC    = fftw_scaledCosTest_debug.exe

RELEASE_DIR  = ./_releasefftw_scaledCosTest
DEBUG_DIR    = ./_debugfftw_scaledCosTest
