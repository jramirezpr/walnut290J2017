...
//
// g++ NERI.cpp -std=c++11 -I../../290J_2015 -lfftw3 -o NERIDETECTOVERFLOW.exe
//
...
double tau=0.05;
    ...
    long zPanels  = 100;
if(xPanels==150){
fout.open("Results150x150x150.txt");
cout<<"FILE 150OPEN";

}
if(xPanels==100){
fout.open("Results100x100x100.txt");
cout<<"FILE OPEN";

}
if(xPanels==50){
fout.open("Results50x50x50.txt");
cout<<"FILE 50 OPEN";
