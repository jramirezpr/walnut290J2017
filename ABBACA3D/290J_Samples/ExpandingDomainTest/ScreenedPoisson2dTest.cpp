...
#include "ExpandingDomainNd/ScreenedSoln2d.h"
...
//
	...
	// Instantiate an exact screened potential with a specified source differentiability

	ScreenedSoln2d screenedPotFunction2d(xBar,yBar, sigma, strength, laplaceCoeff,screenCoeff);
	screenedPotFunction2d.setSourceDifferentiability(sourceDifferentiability);
	...
	exactPotential2d.specify(screenedPotFunction2d.getEvaluationPtr());
	source2d.specify(screenedPotFunction2d.getSourceEvaluationPtr());

    //#####################################################
    // Initialize InversePoisson2d instance
    //#####################################################

    InversePoisson2d inversePoissonOp(laplaceCoeff,screenCoeff,xPanels,xMin,xMax,yPanels,yMin,yMax,extensionFactor);
...
//
    extensionFactor = 4;
    inversePoissonOp.initialize(laplaceCoeff,screenCoeff,xPanels,xMin,xMax,yPanels,yMin,yMax,extensionFactor);
