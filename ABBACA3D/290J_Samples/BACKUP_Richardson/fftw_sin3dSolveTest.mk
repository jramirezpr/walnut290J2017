#
# fftw_sin3dSolveTest program makefile using MakeScripts
#
...
CPPfiles   +=  fftw_sin3dSolveTest.cpp
INCLUDES    = -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  = fftw_sin3dSolveTest.exe
DEBUG_EXEC    = fftw_sin3dSolveTest_debug.exe

RELEASE_DIR  = ./_releasefftw_sin3dSolveTest
DEBUG_DIR    = ./_debugfftw_sin3dSolveTest
