...
CPPfiles     +=   LegendreInterp2dTest.cpp

INCLUDES      += -I./
INCLUDES      += -I$(290J_Dir)

RELEASE_EXEC  = LegendreInterp2dTest.exe
DEBUG_EXEC    = LegendreInterp2dTest_debug.exe


RELEASE_DIR  = ./_releaseLegendreInterp2dTest
DEBUG_DIR    = ./_debugLegendreInterp2dTest
