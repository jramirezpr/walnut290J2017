...
CPPfiles   += CreateH2bamoBasis.cpp
INCLUDES   += -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  =  CreateH2bamoBasis.exe
DEBUG_EXEC    =  CreateH2bamoBasis_debug.exe

RELEASE_DIR  = ./_releaseCreateH2bamoBasis
DEBUG_DIR    = ./_debugCreateH2bamoBasis
