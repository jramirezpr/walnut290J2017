#
# Poisson2dTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = Poisson2dTest.exe
DEBUG_EXEC    = Poisson2dTest_debug.exe


RELEASE_DIR  = ./_releasePoisson2dTest
DEBUG_DIR    = ./_debugPoisson2dTest
