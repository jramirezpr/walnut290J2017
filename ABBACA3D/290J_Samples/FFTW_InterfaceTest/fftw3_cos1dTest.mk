#
# fftw3_cos1dTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = ./fftw3_cos1dTest.exe
DEBUG_EXEC    = ./fftw3_cos1dTestd.exe

RELEASE_DIR  =./_release_fftw3_cos1dTest
DEBUG_DIR    =./_debug_fftw3_cos1dTest
