...
//
// g++ RichExtr1DandStopping.cpp -std=c++11 -I../../290J_2015 -lfftw3 -o RichstoppingCond.exe
//
...
//#include "MollifierNd/HighOrderPolyPotential1D.h"           // Mollified nuclear potential
...
//AB step
  ...
  AUX.setToValue(0.0);
		...
		heatEqStep(tau/2.0,DFT,uIn,AUX,LX,LY,LZ);
...
{ 	inRelerr=innTol+1;
    ...
    int jInner=0;
	while(((jInner<maxIt)&&(inRelerr>innTol)&&(bedrock_flag))||jInner<3)
	{
