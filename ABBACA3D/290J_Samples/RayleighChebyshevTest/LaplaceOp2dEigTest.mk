#
# LaplaceOp2dEigTest program makefile using MakeScripts
#
...
CPPfiles   +=  LaplaceOp2dEigTest.cpp
INCLUDES    = -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  = LaplaceOp2dEigTest.exe
DEBUG_EXEC    = LaplaceOp2dEigTest_debug.exe

RELEASE_DIR  = ./_releaseLaplaceOp2dEigTest
DEBUG_DIR    = ./_debugLaplaceOp2dEigTest
