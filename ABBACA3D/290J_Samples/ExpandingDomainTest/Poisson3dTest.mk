#
# Poisson3dTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = Poisson3dTest.exe
DEBUG_EXEC    = Poisson3dTest_debug.exe


RELEASE_DIR  = ./_releasePoisson3dTest
DEBUG_DIR    = ./_debugPoisson3dTest
