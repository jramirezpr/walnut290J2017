#
# fftw3_sin2dTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = ./fftw3_sin2dTest.exe
DEBUG_EXEC    = ./fftw3_sin2dTestd.exe

RELEASE_DIR  =./_release_fftw3_sin2dTest
DEBUG_DIR    =./_debug_fftw3_sin2dTest
