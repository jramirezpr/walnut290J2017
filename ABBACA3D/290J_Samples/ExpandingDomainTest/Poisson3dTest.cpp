...
//
	...
	SmoothPolyPotential3d potentialFunction3d(xBar,yBar, zBar, sigma, strength, laplaceCoeff);
	potentialFunction3d.setSourceDifferentiability(sourceDifferentiability);
	...
	exactPotential3d.specify(potentialFunction3d.getEvaluationPtr());
	source3d.specify(potentialFunction3d.getSourceEvaluationPtr());
    ...
    inversePoissonOp.initialize(laplaceCoeff, xPanels,  xMin, xMax, yPanels, yMin, yMax, zPanels, zMin, zMax,extensionFactor);
