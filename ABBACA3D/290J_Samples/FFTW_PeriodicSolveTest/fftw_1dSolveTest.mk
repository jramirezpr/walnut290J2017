#
# fftw_1dSolveTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = fftw_1dSolveTest.exe
DEBUG_EXEC    = fftw_1dSolveTest_debug.exe

RELEASE_DIR  = ./_releasefftw_1dSolveTest
DEBUG_DIR    = ./_debugfftw_1dSolveTest
