#
# fftw__scaledSinTest program makefile using MakeScripts
#
...
CPPfiles   +=  fftw_scaledSinTest.cpp
INCLUDES    = -I./
INCLUDES   += -I$(290J_Dir)
...
RELEASE_EXEC  = fftw_scaledSinTest.exe
DEBUG_EXEC    = fftw_scaledSinTest_debug.exe

RELEASE_DIR  = ./_releasefftw_scaledSinTest
DEBUG_DIR    = ./_debugfftw_scaledSinTest
