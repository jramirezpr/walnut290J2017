#
# fftw_scalingTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = fftw_scalingTest.exe
DEBUG_EXEC    = fftw_scalingTest_debug.exe

RELEASE_DIR  = ./_releasefftw_scalingTest
DEBUG_DIR    = ./_debugfftw_scalingTest
