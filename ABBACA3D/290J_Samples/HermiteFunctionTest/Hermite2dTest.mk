#
# Hermite2dTest program makefile using MakeScripts
#
...
CPPfiles     +=   Hermite2dTest.cpp

INCLUDES      += -I./
INCLUDES      += -I$(290J_Dir)


RELEASE_EXEC  = Hermite2dTest.exe
DEBUG_EXEC    = Hermite2dTest_debug.exe


RELEASE_DIR  = ./_releaseHermite2dTest
DEBUG_DIR    = ./_debugHermite2dTest
