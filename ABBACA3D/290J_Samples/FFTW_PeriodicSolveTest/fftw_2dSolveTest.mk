#
# fftw_2dSolveTest program makefile using MakeScripts
#
...
RELEASE_EXEC  = fftw_2dSolveTest.exe
DEBUG_EXEC    = fftw_2dSolveTest_debug.exe

RELEASE_DIR  = ./_releasefftw_2dSolveTest
DEBUG_DIR    = ./_debugfftw_2dSolveTest
